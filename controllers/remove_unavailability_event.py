...
class RemoveUnavailabilityEventVersion2(Resource):
    @requires_auth
...
remove_unavailability_bp = Blueprint('remove_unavailability_event', __name__)
api = Api(remove_unavailability_bp)
api.add_resource(RemoveUnavailabilityEventVersion2, '/removeUnavailableEventVersion2')